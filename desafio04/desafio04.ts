...
//var apiKeyOF: string = 'ff978237fadbba0a3b2c3839340485bd';
let apiKey: string = 'ff978237fadbba0a3b2c3839340485bd';
...
//erro url method body, pesquisar como deixalos any não funcionou
class HttpClient {
